...
public class Modelprelude_man<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "prelude_man"), "main");
	private final ModelPart chinczyk;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition chinczyk = partdefinition.addOrReplaceChild("chinczyk", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition base = chinczyk.addOrReplaceChild("base",
				CubeListBuilder.create().texOffs(0, 21)
						.addBox(-5.0F, -2.0F, -5.0F, 12.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)).texOffs(28, 35)
						.addBox(-4.0F, -10.0F, -4.0F, 10.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 0.0F, 0.0F));

		PartDefinition neck = chinczyk.addOrReplaceChild("neck", CubeListBuilder.create().texOffs(0, 35).addBox(-4.0F,
				-11.0F, -3.0F, 8.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.0F, 0.0F));

		PartDefinition main = chinczyk.addOrReplaceChild("main", CubeListBuilder.create().texOffs(44, 18).addBox(-3.0F,
				-11.0F, -2.0F, 6.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -21.0F, 0.0F));

		PartDefinition cube_r1 = main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(26, 34).addBox(1.0F, -4.0F, -1.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -11.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r2 = main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(56, 0).addBox(-3.0F, -4.0F, -1.0F, 2.0F, 5.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -11.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition head = chinczyk.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -2.0F, -4.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(25, 6)
		...
		PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(56, 10).mirror()
		...
		PartDefinition cube_r4 = head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(56, 15)
						.addBox(-3.25F, 3.5F, 1.75F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(42, 14)
		...
		PartDefinition cube_r6 = head
				.addOrReplaceChild("cube_r6",
						CubeListBuilder.create().texOffs(18, 13).addBox(-3.0F, -35.0F, -7.0F, 2.0F, 1.0F, 4.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 33.5F, 0.0F, 0.0F, 0.3927F, 0.0F));
