...
public class RubyoreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("kaczka:rubyore", FEATURE,
				new OreConfiguration(RubyoreFeatureRuleTest.INSTANCE, KaczkaModBlocks.RUBYORE.get().defaultBlockState(), 6));
		PLACED_FEATURE = PlacementUtils.register("kaczka:rubyore", CONFIGURED_FEATURE, List.of(CountPlacement.of(25), InSquarePlacement.spread(),
	...
	private static class RubyoreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("kaczka:rubyore_match"), CUSTOM_MATCH);
		}
